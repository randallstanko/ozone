...
export default function AuthScreen({ onAuth }) {
  ...
  const handleRegister = async (e) => {
    e.preventDefault()
    clearMessages()
    if (!email.trim() || !password || !name.trim()) return setError('Completa todos los campos')
    ...
    try {
      ...
      // Si la sesion ya esta disponible (email confirmation disabled), llamar onAuth
      if (data.session) {
        onAuth(data.session)
      } else {
    ...
    <div className="auth-screen">
      ...
      <div className="auth-card">
        ...
        <div className="auth-logo">
          <div className="auth-logo-title">Ozone</div>
          <div className="auth-logo-sub">Tu segundo cerebro con IA</div>
        </div>
        ...
        <p className="auth-footer">
          Al continuar aceptas los terminos de uso de Ozone.
        </p>
      </div>
    </div>
  )
